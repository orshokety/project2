...
var Pants = /** @class */ (function (_super) {
    ...
    function Pants(numberOfPockets, pantsLength, maker, model, size, price, color) {
    ...
    Pants.prototype.displayDetials = function () {
    ...
    Pants.prototype.displayImage = function () {
        var img = new Image();
    ...
    Object.defineProperty(Pants.prototype, "brand", {
        get: function () {
    ...
    Object.defineProperty(Pants.prototype, "NumberOfPockets", {
