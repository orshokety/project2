...
var HirShoes = /** @class */ (function (_super) {
    __extends(HirShoes, _super);
    function HirShoes(hirHigh, country, maker, model, size, price, color) {
        var _this = _super.call(this, country, maker, model, size, price, color) || this;
        _this.hirHigh = hirHigh;
        HirShoes.counter++;
        return _this;
    }
    HirShoes.prototype.displayDetials = function () {
    ...
    HirShoes.prototype.displayImage = function () {
        var img = new Image();
    ...
    Object.defineProperty(HirShoes.prototype, "brand", {
        get: function () {
...
//# sourceMappingURL=HirShoes.js.map